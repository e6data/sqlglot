...
for i, row in sample.iterrows():
    test_case = {
        ...
        "expected_supported_functions": row['supported_functions'] if isinstance(row['supported_functions'], list) else [],
        "expected_unsupported_functions": row['unsupported_functions'] if isinstance(row['unsupported_functions'], list) else [],
