    ...
    stages {
        ...
        stage('Prod artifacts- push') {
            ...
            steps {
                ...
                sh 'skopeo copy --all docker://${PROD_IMAGE}:${TAG_VALUE} docker://${DEV_IMAGE}'
                sh 'skopeo copy --all docker://${PROD_IMAGE}:${TAG_VALUE} docker://670514002493.dkr.ecr.us-east-1.amazonaws.com/${RELEASE_NAME}:${TAG_VALUE}'
