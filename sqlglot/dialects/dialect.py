...
class Dialect(metaclass=_Dialect):
    ...
    ANNOTATORS: AnnotatorsType = {
        ...
        **{
        ...
        exp.Interval: lambda self, e: self._annotate_with_type(
    ...
    def get_or_raise(cls, dialect: DialectType) -> Dialect:
        ...
        if isinstance(dialect, str):
            ...
            if not result:
                ...
                similar = (
                    seq_get(get_close_matches(dialect_name, cls.classes, n=1), 0) or ""
                )
                if similar:
...
def no_safe_divide_sql(
    self: Generator, expression: exp.SafeDivide, if_sql: str = "IF"
) -> str:
